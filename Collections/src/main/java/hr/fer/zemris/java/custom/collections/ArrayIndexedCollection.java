...
public class ArrayIndexedCollection<T> implements List<T>{
	 ...
	 *
	 */
	private static class ArrayIndexedElementsGetter<K> implements ElementsGetter<K> {
		
		private ArrayIndexedCollection<K> internColl;
		private int searchIndex = 0;
		private long savedModificationCount;
		
		public ArrayIndexedElementsGetter(ArrayIndexedCollection<K> collection, long modificationCount) {
		...
		public K getNextElement() {
			...
			K valueToReturn = internColl.elements[searchIndex];
			searchIndex++;
	...
	public ArrayIndexedCollection(int initialCapacity, Collection<? extends T> other) {
		...
		elements = initialCapacity < other.size() ? (T[]) new Object[other.size()] : (T[]) new Object[initialCapacity];
		addAll(other);
	}
	
	@Override
	public ElementsGetter<T> createElementsGetter() {
		return new ArrayIndexedElementsGetter<T>(this, modificationCount);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	private void doubleTheSize(T[] copyOfElements) {
		modificationCount++;
	...
	public T get(int index) {
		...
		T objectToReturn = elements[index];
