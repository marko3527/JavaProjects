 ...
 *
 */
public class ToUpperCase extends LocalizableAction {
	 ...
	 */
	public ToUpperCase(String key, ILocalizationProvider provider, DefaultMultipleDocumentModel documents) {
		super(key, provider);
		this.documents = documents;
		this.putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke("control U"));
		this.putValue(SHORT_DESCRIPTION, provider.getString("toUpperDescription"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(selectedText != null){
			...
			String newText = documents.getCurrentDocument().
					  ...
					  replace(selectedText, upperCaseText);
