...
/**
 * Class implementing the multiply action on calculator.
 * 
 * @author Marko
 *
 */
public class MultiplyOperator extends BinaryOperationAction{
	 ...
	 */
	public MultiplyOperator(CalcModelImpl calc) {
		super(calc);
