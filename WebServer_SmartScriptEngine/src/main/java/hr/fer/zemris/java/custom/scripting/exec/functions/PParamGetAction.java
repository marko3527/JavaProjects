 ...
 * exist. It takes the value with key name from request context persistent
 * parameters and puts it at the top of the stack.
 * 
 * @author Marko
 *
 */
public class PParamGetAction implements IFunctionAction{
	
	private RequestContext requestContext;
	
	
	public PParamGetAction(RequestContext requestContext) {
	...
	public void performAction(Stack<Object> tempStack) {
		...
		String parameterValue = requestContext.getPersistentParameter(name);
